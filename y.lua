...
for i,v in pairs(HHEASDFL) do
    for i2,v2 in pairs(v) do
        if v2:match("Left to Dead") or v2:match("Left For Dead?")  then
            table.remove(HHEASDFL,i)
        end
    end
end
local asdfadfg = {}
		...
		if AutoFarmLevel then
			pcall(function()	
				...
				if game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.Visible == false then	
					if mybaby == "Dead Troupe Captain [Lv. 3850]" then		
						getquest("Kill 4 Dead Troupe Captain")
					else
						getquest(mybaby)								
					end
				else
					if not game:GetService("ReplicatedStorage").MOB:FindFirstChild(mybaby) then	
						...
						elseif mybaby == "Dead Troupe Captain [Lv. 3850]" then		
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(9441.71094, 71.7804337, -4433.16016, -0.933587909, 0, -0.358349502, 0, 1, 0, 0.358349502, 0, -0.933587909) * CFrame.new(0,0,3)
						else
