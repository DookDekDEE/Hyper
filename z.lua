...
gotonew = false
tabisland:Toggle("Go To NewWorld",false,function(t)
	gotonew = t
end)
gotoold = false
tabisland:Toggle("Go To OldWorld",false,function(t)
	gotoold = t
end)
...
function checkquest()
	if oldkl then
		...
		if (lvl == 1 or lvl <= 9) or SelectedMonster == "Soldier [Lv. 1]" then
			mybaby = "Soldier [Lv. 1]"
			cframequest = getcframequest("Starter Island Quest")
		elseif (lvl == 10 or lvl <= 19) or SelectedMonster == "Clown Pirate [Lv. 10]" then
			mybaby = "Clown Pirate [Lv. 10]"
			cframequest = getcframequest("Starter Island Quest")
		elseif (lvl == 20 or lvl <= 29) or SelectedMonster == "Smoky [Lv. 20]" then
			mybaby = "Smoky [Lv. 20]"
			cframequest = getcframequest("Starter Island Quest")
		elseif (lvl == 30 or lvl <= 49) or SelectedMonster == "Tashi [Lv. 30]" then
			mybaby = "Tashi [Lv. 30]"
			cframequest = getcframequest("Starter Island Quest")
		elseif (lvl == 50 or lvl <= 74) or SelectedMonster == "Clown Swordman [Lv. 50]" then
			mybaby = "Clown Swordman [Lv. 50]"
			cframequest = getcframequest("Pirate Island Quest")
		elseif (lvl == 75 or lvl <= 99) or SelectedMonster == "The Clown [Lv. 75]" then
			mybaby = "The Clown [Lv. 75]"
			cframequest = getcframequest("Pirate Island Quest")
		elseif (lvl == 100 or lvl <= 119) or SelectedMonster == "Commander [Lv. 100]" then
			mybaby = "Commander [Lv. 100]"
			cframequest = getcframequest("Soldier Town Quest")
		elseif (lvl == 120 or lvl <= 144) or SelectedMonster == "Captain [Lv. 120]" then
			mybaby = "Captain [Lv. 120]"
			cframequest = getcframequest("Soldier Town Quest")
		elseif (lvl == 145 or lvl <= 179) or SelectedMonster == "The Barbaric [Lv. 145]" then
			mybaby = "The Barbaric [Lv. 145]"
			cframequest = getcframequest("Soldier Town Quest")
		elseif (lvl == 180 or lvl <= 199) or SelectedMonster == "Fighter Fishman [Lv. 180]" then
			mybaby = "Fighter Fishman [Lv. 180]"
			cframequest = getcframequest("Shark Island Quest")
		elseif (lvl == 200 or lvl <= 229) or SelectedMonster == "Karate Fishman [Lv. 200]" then
			mybaby = "Karate Fishman [Lv. 200]"
			cframequest = getcframequest("Shark Island Quest")
		elseif (lvl == 230 or lvl <= 249) or SelectedMonster == "Shark Man [Lv. 230]" then
			mybaby = "Shark Man [Lv. 230]"
			cframequest = getcframequest("Shark Island Quest")
		elseif (lvl == 250 or lvl <= 299) or SelectedMonster == "Trainer Chef [Lv. 250]" then
			mybaby = "Trainer Chef [Lv. 250]"
			cframequest = getcframequest("Chef Ship Quest")
		elseif (lvl == 300 or lvl <= 349) or SelectedMonster == "Dark Leg [Lv. 300]" then
			mybaby = "Dark Leg [Lv. 300]"
			cframequest = getcframequest("Chef Ship Quest")
		elseif (lvl == 350 or lvl <= 399) or SelectedMonster == "Dory [Lv. 350]" then
			mybaby = "Dory [Lv. 350]"
			cframequest = getcframequest("Chef Ship Quest")
		elseif (lvl == 400 or lvl <= 449) or SelectedMonster == "Snow Soldier [Lv. 400]" then
			mybaby = "Snow Soldier [Lv. 400]"
			cframequest = getcframequest("Snow Island Quest")
		elseif (lvl == 450 or lvl <= 499) or SelectedMonster == "King Snow [Lv. 450]" then
			mybaby = "King Snow [Lv. 450]"
			cframequest = getcframequest("Snow Island Quest")
		elseif (lvl == 500 or lvl <= 524) or SelectedMonster == "Little Dear [Lv. 500]" then
			mybaby = "Little Dear [Lv. 500]"
			cframequest = getcframequest("Snow Island Quest")
		elseif (lvl == 525 or lvl <= 574) or SelectedMonster == "Candle Man [Lv. 525]" then
			mybaby = "Candle Man [Lv. 525]"
			cframequest = getcframequest("Desert Island Quest")
		elseif (lvl == 575 or lvl <= 624) or SelectedMonster == "Sand Bandit [Lv. 575]" then
			mybaby = "Sand Bandit [Lv. 575]"
			cframequest = getcframequest("Desert Island Quest")
		elseif (lvl == 625 or lvl <= 674) or SelectedMonster == "Bomb Man [Lv. 625]" then
			mybaby = "Bomb Man [Lv. 625]"
			cframequest = getcframequest("Desert Island Quest")
		elseif (lvl == 675 or lvl <= 724) or SelectedMonster == "Desert Marauder [Lv. 675]" then
			mybaby = "Desert Marauder [Lv. 675]"
			cframequest = getcframequest("Desert Island Quest")
		elseif (lvl == 725 or lvl <= 799) or SelectedMonster == "King of Sand [Lv. 725]" then
			mybaby = "King of Sand [Lv. 725]"
			cframequest = getcframequest("Desert Island Quest")
		elseif (lvl == 800 or lvl <= 849) or SelectedMonster == "Sky Soldier [Lv. 800]" then
			mybaby = "Sky Soldier [Lv. 800]"
			cframequest = getcframequest("Skyland Quest")
		elseif (lvl == 850 or lvl <= 899) or SelectedMonster == "Ball Man [Lv. 850]" then
			mybaby = "Ball Man [Lv. 850]"
			cframequest = getcframequest("Skyland 2 Quest")
		elseif (lvl == 900 or lvl <= 949) or SelectedMonster == "Cloud Warrior [Lv. 900]" then
			mybaby = "Cloud Warrior [Lv. 900]"
			cframequest = getcframequest("Skyland Quest")
		elseif (lvl == 950 or lvl <= 999) or SelectedMonster == "Rumble Man [Lv. 950]" then
			mybaby = "Rumble Man [Lv. 950]"
			cframequest = getcframequest("Skyland 2 Quest")
		elseif (lvl == 1000 or lvl <= 1049) or SelectedMonster == "Elite Soldier [Lv. 1000]" then
			mybaby = "Elite Soldier [Lv. 1000]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif (lvl == 1050 or lvl <= 1099) or SelectedMonster == "High-class Soldier [Lv. 1050]" then
			mybaby = "High-class Soldier [Lv. 1050]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif (lvl == 1100 or lvl <= 1149) or SelectedMonster == "Leader [Lv. 1100]" then
			mybaby = "Leader [Lv. 1100]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif (lvl == 1150 or lvl <= 1199) or SelectedMonster == "Pasta [Lv. 1150]" then
			mybaby = "Pasta [Lv. 1150]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif (lvl == 1200 or lvl <= 1249) or SelectedMonster == "Naval personnel [Lv. 1200]" then
			mybaby = "Naval personnel [Lv. 1200]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif (lvl == 1250 or lvl <= 1299) or SelectedMonster == "Wolf [Lv. 1250]" then
			mybaby = "Wolf [Lv. 1250]"
			cframequest = getcframequest("Lobby Island Quest")
		elseif (lvl == 1300 or lvl <= 1349) or SelectedMonster == "Giraffe [Lv. 1300]" then
			mybaby = "Giraffe [Lv. 1300]"
			cframequest = getcframequest("Lobby Island Quest")
		elseif (lvl == 1350 or lvl <= 1399) or SelectedMonster == "Nautical soldier [Lv. 1350]" then
			mybaby = "Nautical soldier [Lv. 1350]"
			cframequest = getcframequest("Lobby Island Quest 2")
		elseif (lvl == 1400 or lvl <= 1449) or SelectedMonster == "Naval soldier [Lv. 1400]" then
			mybaby = "Naval soldier [Lv. 1400]"
			cframequest = getcframequest("Lobby Island Quest 2")
		elseif (lvl == 1450 or lvl <= 1499) or SelectedMonster == "Leo [Lv. 1450]" then
			mybaby = "Leo [Lv. 1450]"
			cframequest = getcframequest("Lobby Island Quest 2")
		elseif (lvl == 1500 or lvl <= 1549) or SelectedMonster == "Zombie [Lv. 1500]" then
			mybaby = "Zombie [Lv. 1500]"
			cframequest = getcframequest("Zombie Island Quest")
		elseif (lvl == 1550 or lvl <= 1599) or SelectedMonster == "Elite Zombie [Lv. 1550]" then
			mybaby = "Elite Zombie [Lv. 1550]"
			cframequest = getcframequest("Zombie Island Quest")
		elseif (lvl == 1600 or lvl <= 1649) or SelectedMonster == "Revenant [Lv. 1600]" then
			mybaby = "Revenant [Lv. 1600]"
			cframequest = getcframequest("Zombie Island Quest")
		elseif (lvl == 1650 or lvl <= 1699) or SelectedMonster == "Shadow Master [Lv. 1650]" then
			mybaby = "Shadow Master [Lv. 1650]"
			cframequest = getcframequest("Zombie Island Quest")
		elseif (lvl == 1700 or lvl <= 1749) or SelectedMonster == "New World Pirate [Lv. 1700]" then
			mybaby = "New World Pirate [Lv. 1700]"
			cframequest = getcframequest("War Island Quest")
		elseif (lvl == 1750 or lvl <= 1799) or SelectedMonster == "Cutlass Pirate [Lv. 1750]" then
			mybaby = "Cutlass Pirate [Lv. 1750]"
			cframequest = getcframequest("War Island Quest")
		elseif (lvl == 1800 or lvl <= 1849) or SelectedMonster == "Rear Admiral [Lv. 1800]" then
			mybaby = "Rear Admiral [Lv. 1800]"
			cframequest = getcframequest("War Island Quest")
		elseif (lvl == 1850 or lvl <= 1924) or SelectedMonster == "True Karate Fishman [Lv. 1850]" then
			mybaby = "True Karate Fishman [Lv. 1850]"
			cframequest = getcframequest("War Island Quest")
		elseif (lvl == 1925 or lvl <= 1999) or SelectedMonster == "Quake Woman [Lv. 1925]" then
			mybaby = "Quake Woman [Lv. 1925]"
			cframequest = getcframequest("War Island Quest")
		elseif (lvl == 2000 or lvl <= 2049) or SelectedMonster == "Fishman [Lv. 2000]" then
			mybaby = "Fishman [Lv. 2000]"
			cframequest = getcframequest("Fishland Quest")
		elseif (lvl == 2050 or lvl <= 2099) or SelectedMonster == "Combat Fishman [Lv. 2050]" then
			mybaby = "Combat Fishman [Lv. 2050]"
			cframequest = getcframequest("Fishland Quest")
		elseif (lvl == 2100 or lvl <= 2149) or SelectedMonster == "Sword Fishman [Lv. 2100]" then
			mybaby = "Sword Fishman [Lv. 2100]"
			cframequest = getcframequest("Fishland Quest")
		elseif (lvl == 2150 or lvl <= 2199) or SelectedMonster == "Soldier Fishman [Lv. 2150]" then
			mybaby = "Soldier Fishman [Lv. 2150]"
			cframequest = getcframequest("Fishland Quest")
		elseif (lvl >= 2200) or SelectedMonster == "Seasoned Fishman [Lv. 2200]" then
	...
	if newkl then
		local lvl = game:GetService("Players").LocalPlayer.PlayerStats.lvl.Value
		if (lvl == 2250 or lvl <= 2299) or SelectedMonster == "Beast Pirate [Lv. 2250]" then
			mybaby = "Beast Pirate [Lv. 2250]"
			cframequest = getcframequest("Japan 1 Quest")
		elseif (lvl == 2300 or lvl <= 2349) or SelectedMonster == "Beast Swordman [Lv. 2300]" then
			mybaby = "Beast Swordman [Lv. 2300]"
			cframequest = getcframequest("Japan 1 Quest")
		elseif (lvl == 2350 or lvl <= 2399) or SelectedMonster == "Gazelle Man [Lv. 2350]" then
			mybaby = "Gazelle Man [Lv. 2350]"
			cframequest = getcframequest("Japan 1 Quest")
		elseif (lvl == 2400 or lvl <= 2449) or SelectedMonster == "Bandit Beast Pirate [Lv. 2400]" then
			mybaby = "Bandit Beast Pirate [Lv. 2400]"
			cframequest = getcframequest("Japan 2 Quest")
		elseif (lvl == 2450 or lvl <= 2499) or SelectedMonster == "Powerful Beast Pirate [Lv. 2450]" then
			mybaby = "Powerful Beast Pirate [Lv. 2450]"
			cframequest = getcframequest("Japan 2 Quest")
		elseif (lvl == 2500 or lvl <= 2549) or SelectedMonster == "Violet Samurai [Lv. 2500]" then
			mybaby = "Violet Samurai [Lv. 2500]"
			cframequest = getcframequest("Japan 2 Quest")
		elseif (lvl == 2550 or lvl <= 2599) or SelectedMonster == "Duke [Lv. 2550]" then
			mybaby = "Duke [Lv. 2550]"
			cframequest = getcframequest("Japan 3 Quest")
		elseif (lvl == 2600 or lvl <= 2649) or SelectedMonster == "Magician [Lv. 2600]" then
			mybaby = "Magician [Lv. 2600]"
			cframequest = getcframequest("Japan 3 Quest")
		elseif (lvl == 2650 or lvl <= 2699) or SelectedMonster == "Kitsune Samurai [Lv. 2650]" then
			mybaby = "Kitsune Samurai [Lv. 2650]"
			cframequest = getcframequest("Japan 3 Quest")
		elseif (lvl == 2700 or lvl <= 2749) or SelectedMonster == "Elite Beast Pirate [Lv. 2700]" then
			mybaby = "Elite Beast Pirate [Lv. 2700]"
			cframequest = getcframequest("Japan 4 Quest")
		elseif (lvl == 2750 or lvl <= 2799) or SelectedMonster == "Bear Man [Lv. 2750]" then
			mybaby = "Bear Man [Lv. 2750]"
			cframequest = getcframequest("Japan 4 Quest")
		elseif (lvl == 2800 or lvl <= 2849) or SelectedMonster == "Bean [Lv. 2800]" then
			mybaby = "Bean [Lv. 2800]"
			cframequest = getcframequest("Japan 4 Quest")
		elseif (lvl == 2850 or lvl <= 2899) or SelectedMonster == "Meji [Lv. 2850]" then
			mybaby = "Meji [Lv. 2850]"
			cframequest = getcframequest("Japan 5 Quest")
		elseif (lvl == 2900 or lvl <= 2949) or SelectedMonster == "Petra [Lv. 2900]" then
			mybaby = "Petra [Lv. 2900]"
			cframequest = getcframequest("Japan 5 Quest")
		elseif (lvl == 2950 or lvl <= 2999) or SelectedMonster == "Kappa [Lv. 2950]" then
			mybaby = "Kappa [Lv. 2950]"
			cframequest = getcframequest("Japan 6 Quest")
		elseif (lvl == 3000 or lvl <= 3024) or SelectedMonster == "Joey [Lv. 3000]" then
			mybaby = "Joey [Lv. 3000]"
			cframequest = getcframequest("Japan 6 Quest")
		elseif (lvl == 3025 or lvl <= 3074) or SelectedMonster == "Skull Pirate [Lv. 3050]" then
			mybaby = "Skull Pirate [Lv. 3050]"
			cframequest = getcframequest("Skull Island Quest")
		elseif (lvl == 3075 or lvl <= 3099) or SelectedMonster == "Elite Skeleton [Lv. 3100]" then
			mybaby = "Elite Skeleton [Lv. 3100]"
			cframequest = getcframequest("Skull Island Quest")
		elseif (lvl == 3100 or lvl <= 3124) or SelectedMonster == "Desert Thief [Lv. 3125]" then
			mybaby = "Desert Thief [Lv. 3125]"
			cframequest = getcframequest("Desert 2nd Quest")
		elseif (lvl == 3125 or lvl <= 3149) or SelectedMonster == "Anubis [Lv. 3150]" then
			mybaby = "Anubis [Lv. 3150]"
			cframequest = getcframequest("Desert 2nd Quest")
		elseif (lvl == 3150  or lvl <= 3174) or SelectedMonster == "Pharaoh [Lv. 3175]" then
			mybaby = "Pharaoh [Lv. 3175]"
			cframequest = getcframequest("Desert 2nd Quest")
		elseif (lvl == 3175 or lvl <= 3199) or SelectedMonster == "Flame User [Lv. 3200]" then
			mybaby = "Flame User [Lv. 3200]"
			cframequest = getcframequest("Desert 2nd Quest")
		elseif (lvl == 3200 or lvl <= 3224) or SelectedMonster == "Chess Soldier [Lv. 3200]" then
			mybaby = "Chess Soldier [Lv. 3200]"
			cframequest = getcframequest("Loaf 1 Quest")
		elseif (lvl == 3225 or lvl <= 3249) or SelectedMonster == "Sunken Vessel [Lv. 3225]" then
			mybaby = "Sunken Vessel [Lv. 3225]"
			cframequest = getcframequest("Loaf 1 Quest")
		elseif (lvl == 3250 or lvl <= 3274) or SelectedMonster == "Biscuit Man [Lv. 3250]" then
			mybaby = "Biscuit Man [Lv. 3250]"	
			cframequest = getcframequest("Loaf 1 Quest")
		elseif (lvl == 3275 or lvl <= 3299) or SelectedMonster == "Dough Master [Lv. 3275]" then
			mybaby = "Dough Master [Lv. 3275]"
			cframequest = getcframequest("Loaf 2 Quest")
		elseif (lvl == 3300 or lvl <= 3324) or SelectedMonster == "Azlan [Lv. 3300]" then
			mybaby = "Azlan [Lv. 3300]"
			cframequest = getcframequest("Shred Endangering Quest")
		elseif (lvl == 3325 or lvl <= 3399)  or SelectedMonster == "The Volcano [Lv. 3325]" then
			mybaby = "The Volcano [Lv. 3325]"
			cframequest = getcframequest("Shred Endangering Quest")
		elseif (lvl == 3400 or lvl <= 3424)  or SelectedMonster == "Dark Beard Servant [Lv. 3400]" then
			mybaby = "Dark Beard Servant [Lv. 3400]"
			cframequest = getcframequest("Skull Pirate Island Quest")
		elseif (lvl == 3425 or lvl <= 3449)  or SelectedMonster == "Supreme Swordman [Lv. 3425]" then
			mybaby = "Supreme Swordman [Lv. 3425]"
			cframequest = getcframequest("Skull Pirate Island Quest")
		elseif (lvl == 3450 or lvl <= 3499 )  or SelectedMonster == "Sally [Lv. 3450]" then
			mybaby = "Sally [Lv. 3450]"
			cframequest = getcframequest("Skull Pirate Island Quest")
		elseif (lvl == 3500 or lvl <= 3524)  or SelectedMonster == "Vice Admiral [Lv. 3500]" then
			mybaby = "Vice Admiral [Lv. 3500]"
			cframequest = getcframequest("Soldier Head Quater 1 Quest")
		elseif (lvl == 3525 or lvl <= 3549)  or SelectedMonster == "Pondere [Lv. 3525]" then
			mybaby = "Pondere [Lv. 3525]"
			cframequest = getcframequest("Soldier Head Quater 1 Quest")
		elseif (lvl == 3550 or lvl <= 3599) or SelectedMonster == "Hefty [Lv. 3550]" then
			mybaby = "Hefty [Lv. 3550]"
			cframequest = getcframequest("Soldier Head Quater 2 Quest")
		elseif (lvl == 3600 or lvl <= 3624) or SelectedMonster == "Fiore Gladiator [Lv. 3600]" then
			mybaby = "Fiore Gladiator [Lv. 3600]"
			cframequest = getcframequest("Fiore 1 Quest")
		elseif (lvl == 3625 or lvl <= 3649) or SelectedMonster == "Fiore Fighter [Lv. 3625]" then
			mybaby = "Fiore Fighter [Lv. 3625]"
			cframequest = getcframequest("Fiore 1 Quest")
		elseif (lvl == 3650 or lvl <= 3674) or SelectedMonster == "Fiore Pirate [Lv. 3650]" then
			mybaby = "Fiore Pirate [Lv. 3650]"
			cframequest = getcframequest("Fiore 2 Quest")
		elseif (lvl == 3675 or lvl <= 3699) or SelectedMonster == "Lomeo [Lv. 3675]" then
			mybaby = "Lomeo [Lv. 3675]"
			cframequest = getcframequest("Fiore 2 Quest")
		elseif (lvl == 3700 or lvl <= 3724) or SelectedMonster == "Prince Aria [Lv. 3700]" then
			mybaby = "Prince Aria [Lv. 3700]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif (lvl == 3725 or lvl <= 3749) or SelectedMonster == "Devastate [Lv. 3725]" then
			mybaby = "Devastate [Lv. 3725]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif (lvl == 3750 or lvl <= 3774) or SelectedMonster == "Physicus [Lv. 3750]" then
			mybaby = "Physicus [Lv. 3750]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif (lvl == 3775 or lvl <= 3799) or SelectedMonster == "Floffy [Lv. 3775]" then
			mybaby = "Floffy [Lv. 3775]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif (lvl == 3800 or lvl <= 3849) or SelectedMonster == "Dead Troupe [Lv. 3800]" then
			mybaby = "Dead Troupe [Lv. 3800]"
			cframequest = getcframequest("Fiore 4 Quest")
		elseif (lvl == 3850 or lvl <= 3974) or SelectedMonster == "Dead Troupe Captain [Lv. 3850]" then
			mybaby = "Dead Troupe Captain [Lv. 3850]"
			cframequest = CFrame.new(10047.3164, 102.078598, -3928.74634, 0.74614042, 1.17333148e-08, -0.665788591, 5.04792723e-08, 1, 7.41946309e-08, 0.665788591, -8.8968136e-08, 0.74614042)
		elseif (lvl >= 3975) or SelectedMonster == "Ryu [Lv. 3975]" then
			mybaby = "Ryu [Lv. 3975]"
			cframequest = getcframequest("Fiore 4 Quest")
		end
	end
	if treekl then
		local lvl = game:GetService("Players").LocalPlayer.PlayerStats.lvl.Value
		if (lvl == 4000 or lvl <= 4049) or SelectedMonster == "Deep Diver [Lv. 4000]" then
			mybaby = "Deep Diver [Lv. 4000]"
			cframequest = getcframequest("The Unearthly 1 Quest")
		elseif (lvl == 4050 or lvl <= 4099) or SelectedMonster == "Fugitive [Lv. 4050]" then
			mybaby = "Fugitive [Lv. 4050]"
			cframequest = getcframequest("The Unearthly 1 Quest")
		elseif (lvl == 4100 or lvl <= 4149) or SelectedMonster == "Deep one Villager [Lv. 4100]" then
			mybaby = "Deep one Villager [Lv. 4100]"
			cframequest = getcframequest("The Unearthly 1 Quest")
		elseif (lvl == 4150 or lvl <= 4199) or SelectedMonster == "Fishman Guardian [Lv. 4150]" then
			mybaby = "Fishman Guardian [Lv. 4150]"
			cframequest = getcframequest("The Unearthly 2 Quest")
		elseif (lvl == 4200 or lvl <= 4249) or SelectedMonster == "The deep one [Lv. 4200]" then
			mybaby = "The deep one [Lv. 4200]"
			cframequest = getcframequest("The Unearthly 2 Quest")
		elseif (lvl >= 4250 or lvl <= 4299) or SelectedMonster == "Fishman King's Guard [Lv. 4250]" then
			mybaby = "Fishman King's Guard [Lv. 4250]"
			cframequest = getcframequest("The Unearthly 2 Quest")
		elseif (lvl >= 4300 or lvl <= 4324) or SelectedMonster == "Jungle Gorilla [Lv. 4300]" then
			mybaby = "Jungle Gorilla [Lv. 4300]"
			cframequest = getcframequest("The Shallow 1 Quest")
		elseif (lvl >= 4325 or lvl <= 4349) or SelectedMonster == "Wilderness Gorilla [Lv. 4325]" then
			mybaby = "Wilderness Gorilla [Lv. 4325]"
			cframequest = getcframequest("The Shallow 1 Quest")
		elseif (lvl >= 4350 or lvl <= 4374) or SelectedMonster == "Jungle Ape [Lv. 4350]" then
			mybaby = "Jungle Ape [Lv. 4350]"
			cframequest = getcframequest("The Shallow 1 Quest")
		elseif (lvl >= 4375) or SelectedMonster == "Cyborg Gorilla [Lv. 4375]" then
...
function checkquestselect()
	if oldkl then
		if SelectedMonstered == "Soldier [Lv. 1]" then
			mybaby = "Soldier [Lv. 1]"
			cframequest = getcframequest("Starter Island Quest")
		elseif SelectedMonstered == "Clown Pirate [Lv. 10]" then
			mybaby = "Clown Pirate [Lv. 10]"
			cframequest = getcframequest("Starter Island Quest")
		elseif SelectedMonstered == "Smoky [Lv. 20]" then
			mybaby = "Smoky [Lv. 20]"
			cframequest = getcframequest("Starter Island Quest")
		elseif SelectedMonstered == "Tashi [Lv. 30]" then
			mybaby = "Tashi [Lv. 30]"
			cframequest = getcframequest("Starter Island Quest")
		elseif SelectedMonstered == "Clown Swordman [Lv. 50]" then
			mybaby = "Clown Swordman [Lv. 50]"
			cframequest = getcframequest("Pirate Island Quest")
		elseif SelectedMonstered == "The Clown [Lv. 75]" then
			mybaby = "The Clown [Lv. 75]"
			cframequest = getcframequest("Pirate Island Quest")
		elseif SelectedMonstered == "Commander [Lv. 100]" then
			mybaby = "Commander [Lv. 100]"
			cframequest = getcframequest("Soldier Town Quest")
		elseif SelectedMonstered == "Captain [Lv. 120]" then
			mybaby = "Captain [Lv. 120]"
			cframequest = getcframequest("Soldier Town Quest")
		elseif SelectedMonstered == "The Barbaric [Lv. 145]" then
			mybaby = "The Barbaric [Lv. 145]"
			cframequest = getcframequest("Soldier Town Quest")
		elseif SelectedMonstered == "Fighter Fishman [Lv. 180]" then
			mybaby = "Fighter Fishman [Lv. 180]"
			cframequest = getcframequest("Shark Island Quest")
		elseif SelectedMonstered == "Karate Fishman [Lv. 200]" then
			mybaby = "Karate Fishman [Lv. 200]"
			cframequest = getcframequest("Shark Island Quest")
		elseif SelectedMonstered == "Shark Man [Lv. 230]" then
			mybaby = "Shark Man [Lv. 230]"
			cframequest = getcframequest("Shark Island Quest")
		elseif SelectedMonstered == "Trainer Chef [Lv. 250]" then
			mybaby = "Trainer Chef [Lv. 250]"
			cframequest = getcframequest("Chef Ship Quest")
		elseif SelectedMonstered == "Dark Leg [Lv. 300]" then
			mybaby = "Dark Leg [Lv. 300]"
			cframequest = getcframequest("Chef Ship Quest")
        elseif SelectedMonstered == "Dory [Lv. 350]" then
			mybaby = "Dory [Lv. 350]"
			cframequest = getcframequest("Chef Ship Quest")
		elseif SelectedMonstered == "Snow Soldier [Lv. 400]" then
			mybaby = "Snow Soldier [Lv. 400]"
			cframequest = getcframequest("Snow Island Quest")
		elseif SelectedMonstered == "King Snow [Lv. 450]" then
			mybaby = "King Snow [Lv. 450]"
			cframequest = getcframequest("Snow Island Quest")
		elseif SelectedMonstered == "Little Dear [Lv. 500]" then
			mybaby = "Little Dear [Lv. 500]"
			cframequest = getcframequest("Snow Island Quest")
		elseif SelectedMonstered == "Candle Man [Lv. 525]" then
			mybaby = "Candle Man [Lv. 525]"
			cframequest = getcframequest("Desert Island Quest")
		elseif SelectedMonstered == "Sand Bandit [Lv. 575]" then
			mybaby = "Sand Bandit [Lv. 575]"
			cframequest = getcframequest("Desert Island Quest")
		elseif SelectedMonstered == "Bomb Man [Lv. 625]" then
			mybaby = "Bomb Man [Lv. 625]"
			cframequest = getcframequest("Desert Island Quest")
		elseif SelectedMonstered == "Desert Marauder [Lv. 675]" then
			mybaby = "Desert Marauder [Lv. 675]"
			cframequest = getcframequest("Desert Island Quest")
		elseif SelectedMonstered == "King of Sand [Lv. 725]" then
			mybaby = "King of Sand [Lv. 725]"
			cframequest = getcframequest("Desert Island Quest")
		elseif SelectedMonstered == "Sky Soldier [Lv. 800]" then
			mybaby = "Sky Soldier [Lv. 800]"
			cframequest = getcframequest("Skyland Quest")
		elseif SelectedMonstered == "Ball Man [Lv. 850]" then
			mybaby = "Ball Man [Lv. 850]"
			cframequest = getcframequest("Skyland 2 Quest")
		elseif SelectedMonstered == "Cloud Warrior [Lv. 900]" then
			mybaby = "Cloud Warrior [Lv. 900]"
			cframequest = getcframequest("Skyland Quest")
		elseif SelectedMonstered == "Rumble Man [Lv. 950]" then
			mybaby = "Rumble Man [Lv. 950]"
			cframequest = getcframequest("Skyland 2 Quest")
		elseif SelectedMonstered == "Elite Soldier [Lv. 1000]" then
			mybaby = "Elite Soldier [Lv. 1000]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif SelectedMonstered == "High-class Soldier [Lv. 1050]" then
			mybaby = "High-class Soldier [Lv. 1050]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif SelectedMonstered == "Leader [Lv. 1100]" then
			mybaby = "Leader [Lv. 1100]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif SelectedMonstered == "Pasta [Lv. 1150]" then
			mybaby = "Pasta [Lv. 1150]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif SelectedMonstered == "Naval personnel [Lv. 1200]" then
			mybaby = "Naval personnel [Lv. 1200]"
			cframequest = getcframequest("Bubbleland Quest")
		elseif SelectedMonstered == "Wolf [Lv. 1250]" then
			mybaby = "Wolf [Lv. 1250]"
			cframequest = getcframequest("Lobby Island Quest")
		elseif SelectedMonstered == "Giraffe [Lv. 1300]" then
			mybaby = "Giraffe [Lv. 1300]"
			cframequest = getcframequest("Lobby Island Quest")
		elseif SelectedMonstered == "Nautical soldier [Lv. 1350]" then
			mybaby = "Nautical soldier [Lv. 1350]"
			cframequest = getcframequest("Lobby Island Quest 2")
		elseif SelectedMonstered == "Naval soldier [Lv. 1400]" then
			mybaby = "Naval soldier [Lv. 1400]"
			cframequest = getcframequest("Lobby Island Quest 2")
		elseif SelectedMonstered == "Leo [Lv. 1450]" then
			mybaby = "Leo [Lv. 1450]"
			cframequest = getcframequest("Lobby Island Quest 2")
		elseif SelectedMonstered == "Zombie [Lv. 1500]" then
			mybaby = "Zombie [Lv. 1500]"
			cframequest = getcframequest("Zombie Island Quest")
		elseif SelectedMonstered == "Elite Zombie [Lv. 1550]" then
			mybaby = "Elite Zombie [Lv. 1550]"
			cframequest = getcframequest("Zombie Island Quest")
		elseif SelectedMonstered == "Revenant [Lv. 1600]" then
			mybaby = "Revenant [Lv. 1600]"
			cframequest = getcframequest("Zombie Island Quest")
		elseif SelectedMonstered == "Shadow Master [Lv. 1650]" then
			mybaby = "Shadow Master [Lv. 1650]"
			cframequest = getcframequest("Zombie Island Quest")
        elseif SelectedMonstered == "New World Pirate [Lv. 1700]" then
			mybaby = "New World Pirate [Lv. 1700]"
			cframequest = getcframequest("War Island Quest")
		elseif SelectedMonstered == "Cutlass Pirate [Lv. 1750]" then
			mybaby = "Cutlass Pirate [Lv. 1750]"
			cframequest = getcframequest("War Island Quest")
		elseif SelectedMonstered == "Rear Admiral [Lv. 1800]" then
			mybaby = "Rear Admiral [Lv. 1800]"
			cframequest = getcframequest("War Island Quest")
		elseif SelectedMonstered == "True Karate Fishman [Lv. 1850]" then
			mybaby = "True Karate Fishman [Lv. 1850]"
			cframequest = getcframequest("War Island Quest")
		elseif SelectedMonstered == "Quake Woman [Lv. 1925]" then
			mybaby = "Quake Woman [Lv. 1925]"
			cframequest = getcframequest("War Island Quest")
		elseif SelectedMonstered == "Fishman [Lv. 2000]" then
			mybaby = "Fishman [Lv. 2000]"
			cframequest = getcframequest("Fishland Quest")
		elseif SelectedMonstered == "Combat Fishman [Lv. 2050]" then
			mybaby = "Combat Fishman [Lv. 2050]"
			cframequest = getcframequest("Fishland Quest")
		elseif SelectedMonstered == "Sword Fishman [Lv. 2100]" then
			mybaby = "Sword Fishman [Lv. 2100]"
			cframequest = getcframequest("Fishland Quest")
		elseif SelectedMonstered == "Soldier Fishman [Lv. 2150]" then
			mybaby = "Soldier Fishman [Lv. 2150]"
			cframequest = getcframequest("Fishland Quest")
		elseif SelectedMonstered == "Seasoned Fishman [Lv. 2200]" then
			mybaby = "Seasoned Fishman [Lv. 2200]"
			cframequest = getcframequest("Fishland Quest")
		end
	end
	if newkl then
		if SelectedMonstered == "Beast Pirate [Lv. 2250]" then
			mybaby = "Beast Pirate [Lv. 2250]"
			cframequest = getcframequest("Japan 1 Quest")
		elseif SelectedMonstered == "Beast Swordman [Lv. 2300]" then
			mybaby = "Beast Swordman [Lv. 2300]"
			cframequest = getcframequest("Japan 1 Quest")
		elseif SelectedMonstered == "Gazelle Man [Lv. 2350]" then
			mybaby = "Gazelle Man [Lv. 2350]"
			cframequest = getcframequest("Japan 1 Quest")
        elseif SelectedMonstered == "Bandit Beast Pirate [Lv. 2400]" then
			mybaby = "Bandit Beast Pirate [Lv. 2400]"
			cframequest = getcframequest("Japan 2 Quest")
        elseif SelectedMonstered == "Powerful Beast Pirate [Lv. 2450]" then
			mybaby = "Powerful Beast Pirate [Lv. 2450]"
			cframequest = getcframequest("Japan 2 Quest")
		elseif SelectedMonstered == "Violet Samurai [Lv. 2500]" then
			mybaby = "Violet Samurai [Lv. 2500]"
			cframequest = getcframequest("Japan 2 Quest")
		elseif SelectedMonstered == "Duke [Lv. 2550]" then
			mybaby = "Duke [Lv. 2550]"
			cframequest = getcframequest("Japan 3 Quest")
		elseif SelectedMonstered == "Magician [Lv. 2600]" then
			mybaby = "Magician [Lv. 2600]"
			cframequest = getcframequest("Japan 3 Quest")
		elseif SelectedMonstered == "Kitsune Samurai [Lv. 2650]" then
			mybaby = "Kitsune Samurai [Lv. 2650]"
			cframequest = getcframequest("Japan 3 Quest")
		elseif SelectedMonstered == "Elite Beast Pirate [Lv. 2700]" then
			mybaby = "Elite Beast Pirate [Lv. 2700]"
			cframequest = getcframequest("Japan 4 Quest")
		elseif SelectedMonstered == "Bear Man [Lv. 2750]" then
			mybaby = "Bear Man [Lv. 2750]"
			cframequest = getcframequest("Japan 4 Quest")
		elseif SelectedMonstered == "Bean [Lv. 2800]" then
			mybaby = "Bean [Lv. 2800]"
			cframequest = getcframequest("Japan 4 Quest")
		elseif SelectedMonstered == "Meji [Lv. 2850]" then
			mybaby = "Meji [Lv. 2850]"
			cframequest = getcframequest("Japan 5 Quest")
		elseif SelectedMonstered == "Petra [Lv. 2900]" then
			mybaby = "Petra [Lv. 2900]"
			cframequest = getcframequest("Japan 5 Quest")
		elseif SelectedMonstered == "Kappa [Lv. 2950]" then
			mybaby = "Kappa [Lv. 2950]"
			cframequest = getcframequest("Japan 6 Quest")
		elseif SelectedMonstered == "Joey [Lv. 3000]" then
			mybaby = "Joey [Lv. 3000]"
			cframequest = getcframequest("Japan 6 Quest")
		elseif SelectedMonstered == "Skull Pirate [Lv. 3050]" then
			mybaby = "Skull Pirate [Lv. 3050]"
			cframequest = getcframequest("Skull Island Quest")
		elseif SelectedMonstered == "Elite Skeleton [Lv. 3100]" then
			mybaby = "Elite Skeleton [Lv. 3100]"
			cframequest = getcframequest("Skull Island Quest")
		elseif SelectedMonstered == "Desert Thief [Lv. 3125]" then
			mybaby = "Desert Thief [Lv. 3125]"
			cframequest = getcframequest("Desert 2nd Quest")
		elseif SelectedMonstered == "Anubis [Lv. 3150]" then
			mybaby = "Anubis [Lv. 3150]"
			cframequest = getcframequest("Desert 2nd Quest")
        elseif SelectedMonstered == "Pharaoh [Lv. 3175]" then
			mybaby = "Pharaoh [Lv. 3175]"
			cframequest = getcframequest("Desert 2nd Quest")
		elseif SelectedMonstered == "Flame User [Lv. 3200]" then
			mybaby = "Flame User [Lv. 3200]"
			cframequest = getcframequest("Desert 2nd Quest")
		elseif SelectedMonstered == "Chess Soldier [Lv. 3200]" then
			mybaby = "Chess Soldier [Lv. 3200]"
			cframequest = getcframequest("Loaf 1 Quest")
		elseif SelectedMonstered == "Sunken Vessel [Lv. 3225]" then
			mybaby = "Sunken Vessel [Lv. 3225]"
			cframequest = getcframequest("Loaf 1 Quest")
		elseif SelectedMonstered == "Biscuit Man [Lv. 3250]" then
			mybaby = "Biscuit Man [Lv. 3250]"	
			cframequest = getcframequest("Loaf 1 Quest")
		elseif SelectedMonstered == "Dough Master [Lv. 3275]" then
			mybaby = "Dough Master [Lv. 3275]"
			cframequest = getcframequest("Loaf 2 Quest")
		elseif SelectedMonstered == "Azlan [Lv. 3300]" then
			mybaby = "Azlan [Lv. 3300]"
			cframequest = getcframequest("Shred Endangering Quest")
        elseif SelectedMonstered == "The Volcano [Lv. 3325]" then
			mybaby = "The Volcano [Lv. 3325]"
			cframequest = getcframequest("Shred Endangering Quest")
		elseif SelectedMonstered == "Dark Beard Servant [Lv. 3400]" then
			mybaby = "Dark Beard Servant [Lv. 3400]"
			cframequest = getcframequest("Skull Pirate Island Quest")
		elseif SelectedMonstered == "Supreme Swordman [Lv. 3425]" then
			mybaby = "Supreme Swordman [Lv. 3425]"
			cframequest = getcframequest("Skull Pirate Island Quest")
		elseif SelectedMonstered == "Sally [Lv. 3450]" then
			mybaby = "Sally [Lv. 3450]"
			cframequest = getcframequest("Skull Pirate Island Quest")
		elseif SelectedMonstered == "Vice Admiral [Lv. 3500]" then
			mybaby = "Vice Admiral [Lv. 3500]"
			cframequest = getcframequest("Soldier Head Quater 1 Quest")
		elseif SelectedMonstered == "Pondere [Lv. 3525]" then
			mybaby = "Pondere [Lv. 3525]"
			cframequest = getcframequest("Soldier Head Quater 1 Quest")
		elseif SelectedMonstered == "Hefty [Lv. 3550]" then
			mybaby = "Hefty [Lv. 3550]"
			cframequest = getcframequest("Soldier Head Quater 2 Quest")
		elseif SelectedMonstered == "Fiore Gladiator [Lv. 3600]" then
			mybaby = "Fiore Gladiator [Lv. 3600]"
			cframequest = getcframequest("Fiore 1 Quest")
		elseif SelectedMonstered == "Fiore Fighter [Lv. 3625]" then
			mybaby = "Fiore Fighter [Lv. 3625]"
			cframequest = getcframequest("Fiore 1 Quest")
		elseif SelectedMonstered == "Fiore Pirate [Lv. 3650]" then
			mybaby = "Fiore Pirate [Lv. 3650]"
			cframequest = getcframequest("Fiore 2 Quest")
		elseif SelectedMonstered == "Lomeo [Lv. 3675]" then
			mybaby = "Lomeo [Lv. 3675]"
			cframequest = getcframequest("Fiore 2 Quest")
		elseif SelectedMonstered == "Prince Aria [Lv. 3700]" then
			mybaby = "Prince Aria [Lv. 3700]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif SelectedMonstered == "Devastate [Lv. 3725]" then
			mybaby = "Devastate [Lv. 3725]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif SelectedMonstered == "Physicus [Lv. 3750]" then
			mybaby = "Physicus [Lv. 3750]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif SelectedMonstered == "Floffy [Lv. 3775]" then
			mybaby = "Floffy [Lv. 3775]"
			cframequest = getcframequest("Fiore 3 Quest")
		elseif SelectedMonstered == "Dead Troupe [Lv. 3800]" then
			mybaby = "Dead Troupe [Lv. 3800]"
			cframequest = getcframequest("Fiore 4 Quest")
		elseif SelectedMonstered == "Dead Troupe Captain [Lv. 3850]" then
			mybaby = "Dead Troupe Captain [Lv. 3850]"
			cframequest = CFrame.new(10047.3164, 102.078598, -3928.74634, 0.74614042, 1.17333148e-08, -0.665788591, 5.04792723e-08, 1, 7.41946309e-08, 0.665788591, -8.8968136e-08, 0.74614042)
        elseif SelectedMonstered == "Ryu [Lv. 3975]" then
			mybaby = "Ryu [Lv. 3975]"
			cframequest = getcframequest("Fiore 4 Quest")
		end
	end
	if treekl then
		if SelectedMonstered == "Deep Diver [Lv. 4000]" then
			mybaby = "Deep Diver [Lv. 4000]"
			cframequest = getcframequest("The Unearthly 1 Quest")
        elseif SelectedMonstered == "Fugitive [Lv. 4050]" then
			mybaby = "Fugitive [Lv. 4050]"
			cframequest = getcframequest("The Unearthly 1 Quest")
		elseif SelectedMonstered == "Deep one Villager [Lv. 4100]" then
			mybaby = "Deep one Villager [Lv. 4100]"
			cframequest = getcframequest("The Unearthly 1 Quest")
		elseif SelectedMonstered == "Fishman Guardian [Lv. 4150]" then
			mybaby = "Fishman Guardian [Lv. 4150]"
			cframequest = getcframequest("The Unearthly 2 Quest")
		elseif SelectedMonstered == "The deep one [Lv. 4200]" then
			mybaby = "The deep one [Lv. 4200]"
			cframequest = getcframequest("The Unearthly 2 Quest")
		elseif SelectedMonstered == "Fishman King's Guard [Lv. 4250]" then
			mybaby = "Fishman King's Guard [Lv. 4250]"
			cframequest = getcframequest("The Unearthly 2 Quest")
		elseif SelectedMonstered == "Jungle Gorilla [Lv. 4300]" then
			mybaby = "Jungle Gorilla [Lv. 4300]"
			cframequest = getcframequest("The Shallow 1 Quest")
		elseif SelectedMonstered == "Wilderness Gorilla [Lv. 4325]" then
			mybaby = "Wilderness Gorilla [Lv. 4325]"
			cframequest = getcframequest("The Shallow 1 Quest")
		elseif SelectedMonstered == "Jungle Ape [Lv. 4350]" then
			mybaby = "Jungle Ape [Lv. 4350]"
			cframequest = getcframequest("The Shallow 1 Quest")
		elseif SelectedMonstered == "Cyborg Gorilla [Lv. 4375]" then
			mybaby = "Cyborg Gorilla [Lv. 4375]"
			cframequest = getcframequest("The Shallow 1 Quest")
		end
	end
...
function checklaw()
	if game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kioru Quest 1" then
		Law_Name = "Kappa [Lv. 2950]"
	elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kioru Quest 2" then
		Law_Name = "Anubis [Lv. 3150]"
	elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kioru Quest 3" then
		Law_Name = "Flame User [Lv. 3200]"
	elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kioru Quest 4" then
		Law_Name = "Sunken Vessel [Lv. 3225]"
	elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kioru Quest 5" then
		Law_Name = "Biscuit Man [Lv. 3250]"
	elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kioru Quest 6" then
	...
	while wait() do
		if gotoold then
			if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("Elite Pirate") then
				...
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-3338.77978515625, 16.768651962280273, 253.11082458496094)
				local args = {
		...
		elseif gotonew then
			if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("Elite Pirate") then
				...
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2162.65527, 17.1356297, -3990.60132, -0.999982297, 1.61774899e-10, 0.00594863063, -2.65700873e-12, 1, -2.76419669e-08, -0.00594863063, -2.76414944e-08, -0.999982297)
				local args = {
					[1] = workspace.AllNPC:FindFirstChild("Elite Pirate")
				}
...
function warptoquest(here)
	if game:GetService("Workspace").AllNPC:FindFirstChild(here) then
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").AllNPC[here].CFrame
	else
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("ReplicatedStorage").NPC[here].HumanoidRootPart.CFrame
	end
end
					...
					if not game:GetService("ReplicatedStorage").MOB:FindFirstChild(mybaby) then	
						...
						for i,v in pairs(game:GetService("Workspace").Monster:GetDescendants()) do
							if v.Name == mybaby and v:FindFirstChild('Humanoid').Health > 0 then
								repeat task.wait()								
									if string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestBoard.TextFrame.QuestName.Text,"%a+"),string.match(mybaby,"%a+")) then
										equip() 
										forfarm(v.HumanoidRootPart.CFrame)
									else	
										getquest(mybaby)											
									end
								until AutoFarmLevel == false or v:FindFirstChild("Humanoid").Health <= 0 or not string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestBoard.TextFrame.QuestName.Text,"%a+"),string.match(mybaby,"%a+")) or game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.Visible == false							
							end	
						end
					else
						if mybaby == "Dough Master [Lv. 3275]" then
					...
					if not game:GetService("ReplicatedStorage").MOB:FindFirstChild(SelectedMonstered) then
						...
						for i,v in pairs(game:GetService("Workspace").Monster:GetDescendants()) do
							if v.Name == SelectedMonstered and v:FindFirstChild('Humanoid').Health > 0 then
								repeat task.wait()								
									if string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestBoard.TextFrame.QuestName.Text,"%a+"),string.match(SelectedMonstered,"%a+")) then
										equip()
										forfarm(v.HumanoidRootPart.CFrame)									
									else
										getquest(SelectedMonstered)
									end
								until not farmselect or v:FindFirstChild("Humanoid").Health <= 0 or not string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestBoard.TextFrame.QuestName.Text,"%a+"),string.match(SelectedMonstered,"%a+")) or game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.Visible == false
							end
						end
					else
						if SelectedMonstered == "Dough Master [Lv. 3275]" then
...
spawn(function()
	while wait() do		
		if QuestCrystal then
			pcall(function()
				checkcrystal()
				if game:GetService("Players").LocalPlayer.PlayerGui.MainGui.StarterFrame["Inventory_Frame"].ScrollingFrameMaterial:FindFirstChild(Name_Crystal) and game:GetService("Players").LocalPlayer.CurrentQuest.Value ~= Name_Quest and (not game:GetService("Workspace").Monster.Boss:FindFirstChild(Name_Boss_Crystal) or not game:GetService("ReplicatedStorage").MOB:FindFirstChild(Name_Boss_Crystal)) then
					find_crystal = false
					local args = {
					    [1] = "QuestSpawnBoss",
					    [2] = {
				...
				elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == Name_Quest then
					find_crystal = false
					if game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.Visible == false then
...
spawn(function()
	while wait() do
		if farmdarkbread then
			pcall(function()
				if game:GetService("Players").LocalPlayer.PlayerGui.MainGui.StarterFrame["Inventory_Frame"].ScrollingFrameMaterial:FindFirstChild("Dark Beard's Totem") and game:GetService("Players").LocalPlayer.CurrentQuest.Value ~= "Kill 1 Dark Beard" then
					local args = {
					    [1] = "QuestSpawnBoss",
					    [2] = {
					...
					game:GetService("ReplicatedStorage").Chest.Remotes.Functions.EtcFunction:InvokeServer(unpack(args))
				elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kill 1 Dark Beard" then
...
spawn(function()
	while wait() do
		if farmlucidus then
			pcall(function()
				if game:GetService("Players").LocalPlayer.PlayerGui.MainGui.StarterFrame["Inventory_Frame"].ScrollingFrameMaterial:FindFirstChild("Lucidus's Totem") and game:GetService("Players").LocalPlayer.CurrentQuest.Value ~= "Kill 1 Lucidus" then
					local args = {
					    [1] = "QuestSpawnBoss",
					    [2] = {
					...
					game:GetService("ReplicatedStorage").Chest.Remotes.Functions.EtcFunction:InvokeServer(unpack(args))
				elseif game:GetService("Players").LocalPlayer.CurrentQuest.Value == "Kill 1 Lucidus" then
