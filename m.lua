					...
					if not game:GetService("ReplicatedStorage").MOB:FindFirstChild(mybaby) then	
						...
						for i,v in pairs(game:GetService("Workspace").Monster:GetDescendants()) do
							if v.Name == mybaby and v:FindFirstChild('Humanoid').Health > 0 then
								repeat task.wait()								
									if string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestCount.Text,"%a+"),string.match(mybaby,"%a+")) then
										equip() 
										forfarm(v.HumanoidRootPart.CFrame)
									else	
										getquest(mybaby)											
									end
								until AutoFarmLevel == false or v:FindFirstChild("Humanoid").Health <= 0 or not string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestCount.Text,"%a+"),string.match(mybaby,"%a+")) or game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.Visible == false							
							end	
						end
					else
						if mybaby == "Dough Master [Lv. 3275]" then
					...
					if not game:GetService("ReplicatedStorage").MOB:FindFirstChild(SelectedMonstered) then
						...
						for i,v in pairs(game:GetService("Workspace").Monster:GetDescendants()) do
							if v.Name == SelectedMonstered and v:FindFirstChild('Humanoid').Health > 0 then
								repeat task.wait()								
									if string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestCount.Text,"%a+"),string.match(SelectedMonstered,"%a+")) then
										equip()
										forfarm(v.HumanoidRootPart.CFrame)									
									else
										getquest(SelectedMonstered)
									end
								until not farmselect or v:FindFirstChild("Humanoid").Health <= 0 or not string.find(string.match(game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.QuestCount.Text,"%a+"),string.match(SelectedMonstered,"%a+")) or game:GetService("Players").LocalPlayer.PlayerGui.MainGui.QuestFrame.Visible == false
							end
						end
					else
						if SelectedMonstered == "Dough Master [Lv. 3275]" then
